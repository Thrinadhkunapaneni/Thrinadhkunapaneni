...
async function addNewThread(e) {
    ...
    try {
        ...
        // home_page(); //this will be impreoved later
        ...
        //attach the eventListners ti the new thread form
...
function buildHomeScreen(threadList) {
  ...
  <tbody id ="thread-view-table-body">
    ...
    // atach event listners to view buttons
...
function buildThreadView(thread) {
    ...
    <td>
    <button class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modal-edit-thread">
    Edit </button>
    </td>
    `;
}